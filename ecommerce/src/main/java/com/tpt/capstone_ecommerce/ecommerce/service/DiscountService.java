...
public interface DiscountService {
    String createDiscount(String shopId, CreateDiscountRequest request) throws RuntimeException, BadRequestException;
    ...
    APISuccessResponseWithMetadata<?> getDiscountsByCreator(String shopId, Integer pageNumber, Integer pageSize) throws NotFoundException, BadRequestException;
