...
public interface CommentService {
    String createComment(String spuId, CreateCommentRequest request) throws NotFoundException;
    ...
    String replyComment(String commentParentId, CreateCommentRequest request) throws NotFoundException;
